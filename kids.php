...
This is the Junior login page, where you enter as an under 18 years old member, 
which allows you to play a game, and displays age-appropriate films. -->
...
if(isset($_SESSION ['kidsuser']))
   ...
   echo "</div>";
   echo ' <div class="col-md-6 how-img">';
   echo '<a class="button" href="https://cdn.htmlgames.com/SnowBalls/">';
   echo  '<button type="button" class="btn btn-outline-warning btn-lg btn-block"><i class="bi-play"></i> Play a Game</button></a>'; 
   echo "<br>";
   echo "<br>";
   echo "<br>";
   echo "<br>";
   echo "<h3> Films To Watch Now </h3>";
   echo "<br>";
   echo ('<a href="kids.php#first">');
  ...
  echo "</div>";
   ...
   $sql3 = "SELECT * FROM cinema WHERE category ='kids'";
   ...
   echo '<div class="col-md-6">';
    ...
    echo "</div>";
    echo ' <div class="col-md-6 how-img">';
    echo "<p>Sorry, you don't have access to this page</p>";
    echo "<h1>Please login as a junior member to see  kids films or to play a game</h1>";
